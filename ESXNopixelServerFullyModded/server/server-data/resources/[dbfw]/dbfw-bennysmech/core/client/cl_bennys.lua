...
local function saveVehicle()
	...
	local myCar = DBFWCore.Game.GetVehicleProperties(veh)
    TriggerServerEvent('dbfw-bennysmech:updateVehicle',myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("dbfw-bennysmech:attemptPurchase", type, upgradeLevel)
                ...
                if nearbennyLocationLSC1 then
                    if not isPlyInBennys then
                        ...
                        if IsControlJustReleased(1, 38) then
                            if DBFWCore.GetPlayerData().job.name == 'mechanic' then
...
--#[Event Handlers]#--
RegisterNetEvent("dbfw-bennysmech:purchaseSuccessful")
AddEventHandler("dbfw-bennysmech:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("dbfw-bennysmech:purchaseFailed")
AddEventHandler("dbfw-bennysmech:purchaseFailed", function()
