...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("dbfw-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("dbfw-bennys:purchaseSuccessful")
AddEventHandler("dbfw-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("dbfw-bennys:purchaseFailed")
AddEventHandler("dbfw-bennys:purchaseFailed", function()
