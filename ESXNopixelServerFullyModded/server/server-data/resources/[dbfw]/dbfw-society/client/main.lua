...
function EnableSocietyMoneyHUDElement()
	...
	DBFWCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	DBFWCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	DBFWCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	DBFWCore.TriggerServerCallback('dbfw-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			DBFWCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('dbfw-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			DBFWCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('dbfw-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			DBFWCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('dbfw-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	DBFWCore.TriggerServerCallback('dbfw-society:getEmployees', function(employees)
		...
		DBFWCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				DBFWCore.TriggerServerCallback('dbfw-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	DBFWCore.TriggerServerCallback('dbfw-society:getOnlinePlayers', function(players)
		...
		DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
...
function OpenPromoteMenu(society, employee)
	...
	DBFWCore.TriggerServerCallback('dbfw-society:getJob', function(job)
		...
		DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
...
function OpenManageGradesMenu(society)
	...
	DBFWCore.TriggerServerCallback('dbfw-society:getJob', function(job)
		...
		DBFWCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			DBFWCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					DBFWCore.TriggerServerCallback('dbfw-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('dbfw:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		DBFWCore.TriggerServerCallback('dbfw-society:getSocietyMoney', function(money)
...
RegisterNetEvent('dbfw-addonaccount:setMoney')
AddEventHandler('dbfw-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('dbfw-society:openBossMenu', function(society, close, options)
