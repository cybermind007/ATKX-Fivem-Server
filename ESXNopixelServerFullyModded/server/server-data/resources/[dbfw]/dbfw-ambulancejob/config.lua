...
Config.Vehicles = {
	{ name = 'emsa', label = "Ambulance", grade = 0},
	{ name = 'emsv', label = "Medical Examiner Van", grade = 0},
	{ name = 'emsc', label = "Charger", grade = 0},
	{ name = 'emsf', label = "F-350", grade = 0},
	{ name = 'emst', label = "Tahoe", grade = 0},
 }
 ...
 Config.Locations = {   
	["vehicle"] = {
	   [1] = {x = 293.5456, y = -605.8678, z = 43.3284, h = 90.654},
	},
 }
