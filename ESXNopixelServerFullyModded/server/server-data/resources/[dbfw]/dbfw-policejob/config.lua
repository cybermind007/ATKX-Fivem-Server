...
Config.Vehicles = {
	{ name = 'polvic', label = "Crown Vic", grade = 0},
	{ name = 'poltaurus', label = "Taurus", grade = 0},
	{ name = 'poltah', label = "Tahoe", grade = 0},
	{ name = 'polchar', label = "Ranger", grade = 0},
	{ name = 'poltaurus', label = "Charger", grade = 0},
	{ name = 'pbus2', label = "Prison Bus", grade = 0},
	{ name = 'policet', label = "Transport Van", grade = 0},
	{ name = '2015polstang', label = "Mustang", grade = 0},
 }
...
Config.PoliceStations = {
	...
	LSPD = {
		...
		BossActions = {
			vector3(462.8604, -984.8693, 30.69637)
		}
...
Config.Locations = {   
	["vehicle"] = {
	   ...
	   [3] = { x = 539.6934443, y = -3125.85783, z = 6.0745454},
	},
 }
